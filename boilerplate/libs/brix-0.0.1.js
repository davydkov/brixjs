(function (root, factory) {
    ...
    "use strict";
    Backbone.Brix = (function (Underscore, Backbone, Marionette) {
        ...
        Brix.PlaceController.prototype = {
            ...
            _bindPlace: function (routeName, PlaceClass) {
                ...
                _sharedRouter.route(route, routeName, Underscore.bind(function (paramsString) {
                    ...
                    this.trigger("place:change", place);
                }, this));
            },
            /**
        ...
        Brix.ActivityManager.prototype = {
            ...
            start: function (placeChangeInitiator, region, place) {
                this.stop();
                this.region = region;
                this.bindTo(placeChangeInitiator, "place:change", _activityManagerOnPlaceChange);
                if (place) {
        ...
        Brix.CompositeManager.prototype = {
            ...
            start: function (placeChangeInitiator, region, place) {
                this.stop();
                this.region = region;
                this.bindTo(placeChangeInitiator, "place:change", _compositeManagerOnPlaceChange);
                if (place) {
